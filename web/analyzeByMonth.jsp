                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <select name="month" id="month" required>
                                                                <option value="1" <%=selectOption[1]%>> Jan
                                                                </option>
                                                                <option value="2" <%=selectOption[2]%>> Feb
                                                                </option>
                                                                <option value="3" <%=selectOption[3]%>> Mar
                                                                </option>
                                                                <option value="4" <%=selectOption[4]%>> Apr
                                                                </option>
                                                                <option value="5" <%=selectOption[5]%>> May
                                                                </option>
                                                                <option value="6" <%=selectOption[6]%>> Jun
                                                                </option>
                                                                <option value="7" <%=selectOption[7]%>> Jul
                                                                </option>
                                                                <option value="8" <%=selectOption[8]%>> Aug
                                                                </option>
                                                                <option value="9" <%=selectOption[9]%>> Sep
                                                                </option>
                                                                <option value="10" <%=selectOption[10]%>> Oct
                                                                </option>
                                                                <option value="11" <%=selectOption[11]%>> Nov
                                                                </option>
                                                                <option value="12" <%=selectOption[12]%>> Dec
                                                                </option>
                                                            </select>&nbsp;&nbsp;
                                                            <select name="year" id="year" required>
                                                                <option value="2014" <%=selectYear[0]%>> 2014
                                                                </option>
                                                                <option value="2015" <%=selectYear[1]%>> 2015
                                                                </option>
                                                            </select>
                                                        </td>
                                                        <td>
                            ...
                            %>
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <%double roundO = (double) (Math.round(totalRevenue * 100.0) / 100.0);%>
                                                                $
                                                                <%=roundO%>
                                                        </td>
                                                    </tr>
