                                                                            ...
                                                                            <table>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <br>
                                                                                        <input type="text" name="source" id="source" value=<%=flight.getSource()%> maxlength="20" required />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <br>
                                                                                        <input type="text" name="destination" id="destination" value=<%=flight.getDestination()%> maxlength="20" required />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <br>
                                                                                        <input type="number" name="fare" id="fare" value=<%=flight.getFare()%> step="any" maxlength="6" required />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
