    ...
    <body class="Background">
        ...
        <%@include file="/user-navigation.jsp" %>
            <%@include file="/site-navigation.jsp" %>
                ...
                <div class="Main">
                    <a href='index.jsp'> Home </a> > <a href='add.jsp'> Add Flight </a>
                    <br>
                    <br>
                                    ...
                                    <form action="AdminController" method="get">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <br>
                                                    <input type="text" name="source" id="source" maxlength="20" required />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <br>
                                                    <input type="text" name="destination" id="destination" maxlength="20" required />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <br>
                                                    <input type="number" name="fare" id="fare" step="any" maxlength="6" required />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
